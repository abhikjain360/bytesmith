...
fn ethernet_mode3_round_trips_and_pins_wire_bytes() {
    use bytesmith_protocols::ethernet::{
...
fn ethernet_mode1_setters_and_mut_slices() {
    use bytesmith_protocols::ethernet::{EthernetIILens, EthernetIIWriter};
...
fn vlan_round_trips_and_derives_constant_tpid() {
    use bytesmith_protocols::vlan::{Vlan, VlanContent, VlanWriter};
...
fn ipv6_round_trips_and_derives_payload_len() {
    use bytesmith_protocols::ip::{Ipv6, Ipv6Content, Ipv6Lens, Ipv6Writer};
...
fn udp_round_trips_affine_length_region() {
    use bytesmith_protocols::udp::{Udp, UdpContent, UdpLens, UdpWriter};
...
fn udp_mode2_writer_over_edits_fixed_field_in_place() {
    use bytesmith_protocols::udp::{Udp, UdpWriter};
